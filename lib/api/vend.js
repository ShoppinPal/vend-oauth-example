...
exports.token = function(req,res){
  ...
  if (!req.query.code) {
    ...
    var tokenUrl = nconf.get('vend:token_service').replace(/\{DOMAIN_PREFIX\}/, req.query.domain_prefix);
    ...
    vend.getInitialAccessToken(
      ...
      .then(function(){ //sample call w/ oauth
        ...
        /*console.log('nconfTemp.get(): ', nconfTemp.get());
        console.log('nconfTemp.get(\'domain_prefix\')',nconfTemp.get('domain_prefix'));
        console.log('nconfTemp.get(\'access_token\')',nconfTemp.get('access_token'));*/
